...
exercise <- exercise %>%
  mutate(
    VigorousWork = ifelse(is.na(VigorousWork), 2, VigorousWork),
...
**Exercise Achievement Rates**:
- Approximately **`r round(100 * sum(exercise$MinimumExercise == "Yes") / nrow(exercise), 1)`%** of participants meet WHO minimum exercise recommendations
- **`r round(100 * sum(exercise$LackExercise == "Yes") / nrow(exercise), 1)`%** do not meet minimum requirements

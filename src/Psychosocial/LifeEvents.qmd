...
Patient-reported flare (n= 1596, number of events= 579) - no significance across any analysis.
...
Patient-reported flare (n= 782, number of events= 305) - no associations. 
...
Patient-reported flare (n= 814, number of events= 274) - no significance across any analysis.

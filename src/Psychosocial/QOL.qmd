...
Here we present the summary findings of tests for association. The results can then be seen in the sections and code below.
...
Mental health scores (MCS12) : No statistical significance by diagnosis type
...
# Note: consider a different p adjust than bonferroni?

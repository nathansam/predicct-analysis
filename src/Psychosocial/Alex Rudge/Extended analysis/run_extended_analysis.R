...
# Run from the Extended analysis directory in the predicct-analysis project.
...
setwd("/Users/arudge/GitHub/predicct-analysis/src/Psychosocial/Alex Rudge/Extended analysis")

...
# Spline for control
summon_lrt(cox_vas_soft, remove = 'OverallControl', add = 'ns(OverallControl, df = 2)')
# Yes
...
# Spline for control
summon_lrt(cox_vas_soft, remove = 'ns(OverallControl, df = 2)', add = 'ns(OverallControl, df = 3)')
# No, df = 2 is sufficient


# Control-8 score
cox_control8_soft <- coxph(
  Surv(time, DiseaseFlareYN) ~
    control_8 +
    frailty(SiteNo),
  data = data_survival_anxiety_soft
...
# Spline
summon_lrt(cox_control8_soft, remove = 'control_8', add = 'ns(control_8, df = 2)')
# No
...
# Spline for control
summon_lrt(cox_vas_hard, remove = 'OverallControl', add = 'ns(OverallControl, df = 2)')
# No

# Control-8
cox_control8_hard <- coxph(
  Surv(time, DiseaseFlareYN) ~
    control_8 +
    frailty(SiteNo),
  data = data_survival_anxiety_hard
...
# Spline
summon_lrt(cox_control8_hard, remove = 'control_8', add = 'ns(control_8, df = 2)')
# No
...
# Spline for control
summon_lrt(cox_vas_soft_uc, remove = 'OverallControl', add = 'ns(OverallControl, df = 2)')
# Yes
...
summon_lrt(cox_vas_soft_uc, remove = 'ns(OverallControl, df = 2)', add = 'ns(OverallControl, df = 3)')
# No, df = 2 is sufficient

# Control-8
cox_control8_soft_uc <- coxph(
  Surv(time, DiseaseFlareYN) ~
    control_8 +
    frailty(SiteNo),
  data = data_survival_anxiety_soft_uc
...
# Spline
summon_lrt(cox_control8_soft_uc, remove = 'control_8', add = 'ns(control_8, df = 2)')
# Yeh go on then
...
# Spline df = 3
summon_lrt(cox_control8_soft_uc, remove = 'ns(control_8, df = 2)', add = 'ns(control_8, df = 3)')
# No, df = 2 is sufficient
...
# Spline for control
summon_lrt(cox_vas_hard_uc, remove = 'OverallControl', add = 'ns(OverallControl, df = 2)')
# No

# Control 8
cox_control8_hard_uc <- coxph(
  Surv(time, DiseaseFlareYN) ~
    control_8 +
    frailty(SiteNo),
  data = data_survival_anxiety_hard_uc
...
# Spline
summon_lrt(cox_control8_hard_uc, remove = 'control_8', add = 'ns(control_8, df = 2)')
# No
...
plot_continuous_hr(
  data = data_survival_anxiety_hard_uc, 
  model = cox_vas_hard_uc, 
  variable = 'OverallControl')

# Control 8
plot_continuous_hr(
  data = data_survival_anxiety_hard_uc, 
  model = cox_control8_hard_uc, 
  variable = 'control_8')
...
# Spline for control
summon_lrt(cox_vas_soft_cd, remove = 'OverallControl', add = 'ns(OverallControl, df = 2)')
# Yes
...
summon_lrt(cox_vas_soft_cd, remove = 'ns(OverallControl, df = 2)', add = 'ns(OverallControl, df = 3)')
# No, df = 2 is sufficient

# Control 8
cox_control8_soft_cd <- coxph(
  Surv(time, DiseaseFlareYN) ~
    control_8 +
    frailty(SiteNo),
  data = data_survival_anxiety_soft_cd
...
# Spline
summon_lrt(cox_control8_soft_cd, remove = 'control_8', add = 'ns(control_8, df = 2)')
# No
...
# Spline for control
summon_lrt(cox_vas_hard_cd, remove = 'OverallControl', add = 'ns(OverallControl, df = 2)')
# No

# Control 8
cox_control8_hard_cd <- coxph(
  Surv(time, DiseaseFlareYN) ~
    control_8 +
    frailty(SiteNo),
  data = data_survival_anxiety_hard_cd
...
# Spline
summon_lrt(cox_control8_hard_cd, remove = 'control_8', add = 'ns(control_8, df = 2)')
# No
...
plot_continuous_hr(
  data = data_survival_anxiety_hard_cd, 
  model = cox_vas_hard_cd, 
  variable = 'OverallControl')

# Control 8
plot_continuous_hr(
  data = data_survival_anxiety_hard_cd, 
  model = cox_control8_hard_cd, 
  variable = 'control_8')
...
Full cohort, soft, vas df = 2, hard, no.

UC, soft, vas df = 2, control8 df = 2. Hard, age df = 4, FC df = 2.

CD, soft, vas df = 2. Hard, no splines.
...
cox_anxiety_cts_hard_uc_mice <- coxph_mice(
  Surv(time, DiseaseFlareYN) ~
    hads_score + IMD + Sex + age_decade + FC + flare_group + OverallControl + control_8 + Smoke + frailty(SiteNo),
  data = data_survival_anxiety_hard_uc,
  m = 20,
  printFlag = FALSE
)

...
data_survival_depression_soft %>%
  survfit(Surv(time, DiseaseFlareYN) ~ score_group, data = .) %>%
  ggsurvplot(data = data_survival_depression_soft,
             conf.int = TRUE,
...
data_survival_depression_hard %>%
  survfit(Surv(time, DiseaseFlareYN) ~ score_group, data = .) %>%
  ggsurvplot(data = data_survival_depression_hard,
             conf.int = TRUE,
             ggtheme = theme_minimal())
...
data_survival_depression_soft_uc %>%
  survfit(Surv(time, DiseaseFlareYN) ~ score_group, data = .) %>%
  ggsurvplot(data = data_survival_depression_soft_uc,
             conf.int = TRUE,
             ggtheme = theme_minimal())
...
data_survival_depression_hard_uc %>%
  survfit(Surv(time, DiseaseFlareYN) ~ score_group, data = .) %>%
  ggsurvplot(data = data_survival_depression_hard_uc,
             conf.int = TRUE,
             ggtheme = theme_minimal())
...
data_survival_depression_soft_cd %>%
  survfit(Surv(time, DiseaseFlareYN) ~ score_group, data = .) %>%
  ggsurvplot(data = data_survival_depression_soft_cd,
             conf.int = TRUE,
             ggtheme = theme_minimal())
...
data_survival_depression_hard_cd %>%
  survfit(Surv(time, DiseaseFlareYN) ~ score_group, data = .) %>%
  ggsurvplot(data = data_survival_depression_hard_cd,
             conf.int = TRUE,
             ggtheme = theme_minimal())

...
QOL %<>% 
  dplyr::mutate(MCS12_binary = ifelse(MCS12 >= 50, "50+", "<50")) %>%
  dplyr::mutate(MCS12_binary = forcats::fct_relevel(MCS12_binary, "50+", "<50"))
...
UC, soft, control df = 2, MCS12 df = 2. Hard, age df = 4, FC df = 2.

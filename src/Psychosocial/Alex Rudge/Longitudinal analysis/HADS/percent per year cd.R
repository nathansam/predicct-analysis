...
# CD
data_anxiety_soft_long %>% dplyr::filter(diagnosis2 == 'CD')
data_anxiety_hard_long %>% dplyr::filter(diagnosis2 == 'CD')
data_depression_soft_long %>% dplyr::filter(diagnosis2 == 'CD')
data_depression_hard_long %>% dplyr::filter(diagnosis2 == 'CD')

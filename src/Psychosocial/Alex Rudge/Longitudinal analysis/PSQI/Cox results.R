...
source("~/GitHub/predicct-analysis/src/Psychosocial/Alex Rudge/Longitudinal analysis/PSQI/tdc model uc.R")
source("~/GitHub/predicct-analysis/src/Psychosocial/Alex Rudge/Longitudinal analysis/PSQI/tdc model cd.R")


# Anxiety
# Extract Cox results
cox_results_psqi_cc <- extract_tdc_results(

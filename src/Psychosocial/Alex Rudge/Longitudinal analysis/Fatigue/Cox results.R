...
source("~/GitHub/predicct-analysis/src/Psychosocial/Alex Rudge/Longitudinal analysis/Fatigue/tdc model uc.R")
source("~/GitHub/predicct-analysis/src/Psychosocial/Alex Rudge/Longitudinal analysis/Fatigue/tdc model cd.R")


# Anxiety
# Extract Cox results
cox_results_fatigue_cc <- extract_tdc_results(

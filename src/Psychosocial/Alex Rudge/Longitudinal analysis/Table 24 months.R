...
tbl <- data_table %>%
    ...
    .tbl_fun = ~
      ...
      gtsummary::tbl_summary(
        ...
        label = list(
          ...
          soft_flare_flag ~ 'Patient reported flare before 24 months',
          hard_flare_flag ~ 'Objective flare before 24 months'
        )
      ) %>% 
      gtsummary::add_p(
  ...
  gt::tab_spanner(
    label = gt::md("**24-month questionnaire**"),
...
tbl %>%
  gt::gtsave(
    filename = glue::glue("{filepath_save}Table 24 months.docx")
  )

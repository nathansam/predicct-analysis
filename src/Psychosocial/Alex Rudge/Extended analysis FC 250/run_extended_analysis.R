...
# Run from the Extended analysis FC 250 directory in the predicct-analysis project.
...
setwd("/Users/arudge/GitHub/predicct-analysis/src/Psychosocial/Alex Rudge/Extended analysis FC 250")

...
Missing data handled using a complete case analysis.
...
Extending the primary analysis by additionally adjusting for IBD-control-8 and IBD-control-VAS scores, and whether the participant had experienced a flare in the previous year.
...
Additionally adjusting for IBD-control-8 and IBD-control-VAS scores, and whether the participant had experienced a flare in the previous year (self-reported).
...
Patients with Crohn's disease, ulcerative colitis and IBDU analysed together.

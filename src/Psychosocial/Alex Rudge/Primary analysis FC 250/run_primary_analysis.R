...
# Run from the Primary analysis FC 250 directory in the predicct-analysis project.
...
setwd("/Users/arudge/GitHub/predicct-analysis/src/Psychosocial/Alex Rudge/Primary analysis FC 250")

...
# Complete case
cox_results_phq12_cts_cc <- extract_cox_results_cts(
...
# MICE
cox_results_phq12_cts_mice <- extract_cox_results_cts(
  data = data_survival_soft_uc,
...
# Save
filepath <- "/Volumes/igmm/cvallejo-predicct/people/Alex/Predicct2/Data/Primary analysis FC 250/"

readr::write_rds(
  x = cox_results_phq12_cts_cc,
  file = paste0(filepath, "cox_results_phq12_cts_cc.rds")
)

readr::write_rds(
  x = cox_results_phq12_cts_mice,
  file = paste0(filepath, "cox_results_phq12_cts_mice.rds")
)

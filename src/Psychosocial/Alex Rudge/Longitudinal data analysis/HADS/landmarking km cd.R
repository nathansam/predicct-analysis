...
data_anxiety_soft_uc <- data_anxiety_soft %>% dplyr::filter(diagnosis2 == "CD")
data_anxiety_hard_uc <- data_anxiety_hard %>% dplyr::filter(diagnosis2 == "CD")
data_depression_soft_uc <- data_depression_soft %>% dplyr::filter(diagnosis2 == "CD")
data_depression_hard_uc <- data_depression_hard %>% dplyr::filter(diagnosis2 == "CD")

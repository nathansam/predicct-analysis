...
# Fit the Cox
cox_depression_soft_cd_pool <- with(cox_depression_soft_cd_mice,
                            coxph(
                              Surv(time, DiseaseFlareYN) ~
                                score_group +
                                IMD +
...
Repeating survival analysis with moderate (8-10) and severe (11-21) scores grouped into a single category (8-21).

...
Patients completed the Hospital Anxiety and Depression Scale upon their recruitment to the study (baseline). In this analysis, our aim is to determine the extent to which anxiety, and depression scores are associated with subsequent patient-reported and objective flares. In the following, we present the steps used to clean and analyse the data to achieve this aim.
...
During data cleaning we:

-   Remove completely empty rows.

-   Combine data from different sources: demographics, HADS questionnaire responses, faecal calprotectin (FC) measurements, index of multiple deprivation (IMD), flare history, and IBD control scores.

...
```
##### IBD type {.toc-ignore .unnumbered}
```{r}
# Plots
...
```
##### Faecal Calprotectin {.toc-ignore .unnumbered}
```{r}
summon_baseline_plot_continuous(
  data = data_baseline_anxiety,
  stat_tests = statistical_tests,

...
Assessing the sensitivity of the primary analysis to the decision to use complete cases to handle missingness, and the choice of variables to adjust for in the models.

...
plot_anxiety_hard <- data_anxiety_hard_long %>%
  ...
  labs(color = "Objective flare",
       ...
       x = "Month",
       y = "Mean Anxiety HADS") +
  #ggtitle("Anxiety HADS over time in IBD by objective flare status") +
  custom_theme
...
plot_depression_soft <- data_depression_soft_long %>%
  ...
  #ggtitle("Depression HADS over time in IBD by patient-reported flare status") +
  custom_theme
...
plot_depression_hard <- data_depression_hard_long %>%
  ...
  labs(color = "Objective flare",
       ...
       x = "Month",
       y = "Mean Depression HADS") +
  #ggtitle("Depression HADS over time in IBD by objective flare status") +
  custom_theme
...
plot_anxiety_soft + plot_anxiety_hard +
  ...
  plot_annotation(
    title = "HADS scores over time in IBD by flare type"
  ) &
  theme(
    plot.title = element_text(hjust = 0.5),
    legend.position = "top"

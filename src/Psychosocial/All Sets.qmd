...
# if needed
softflareplot <-read.xlsx("/Users/chiaracotronei/Desktop/Documents/Research/SoftFlarePlot.xlsx")
hardflareplot <- read.xlsx("/Users/chiaracotronei/Desktop/Documents/Research/HardFlarePlot.xlsx")
```
...
p2 <- ggplot(table_data, aes(x = 1, y = 1)) +
  geom_blank() +
  theme_void() +
  theme(plot.margin = margin(0, 0, 0, 0)) +
  annotation_custom(
    grob = tableGrob(table_data, rows = NULL),

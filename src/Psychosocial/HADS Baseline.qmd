...
n_underage <- nrow(hads_with_demographics[hads_with_demographics$age <= 17,])
hads_with_demographics <- hads_with_demographics[hads_with_demographics$age > 17,]



#make sex into factor
hads_with_demographics$Sex <- factor(hads_with_demographics$Sex,
                                     levels = c(1, 2),
...
hads_with_demographics <- hads_with_demographics %>% 
  left_join(demo %>% select(ParticipantNo, FC, cat, IMD), by = "ParticipantNo")
...
#Join flare data
hads_with_demographics <- hads_with_demographics %>% 
  left_join(IBD %>% select(ParticipantNo, FlaresInPastYear), by = "ParticipantNo")
#create flare groups
hads_with_demographics <- hads_with_demographics %>%
  mutate(flare_group = ifelse(FlaresInPastYear == 0, "No flares", "One or more flares"))
#make flares into levels
hads_with_demographics$flare_group <- factor(hads_with_demographics$flare_group, levels = c( "No flares","One or more flares"))
hads_with_demographics <- hads_with_demographics %>% 
...
At baseline, anxiety scores tended to be higher for anxiety compared to
depression. 
...
#| tbl-cap: "Distribution of baseline anxiety scores by diagnosis type"
table1::table1(~ score_group | diagnosis2,
  data = filtered_data_anxiety,
  render.continuous = my.render.cont
)

#| tbl-cap: "Distribution of baseline anxiety scores by sex"
table1::table1(~ score_group | Sex,
  data = filtered_data_anxiety,
  render.continuous = my.render.cont
)

#| tbl-cap: "Distribution of baseline anxiety scores by age group"
table1::table1(~ score_group | AgeGroup,
  data = filtered_data_anxiety,
  render.continuous = my.render.cont
)

#| tbl-cap: "Distribution of baseline anxiety scores by previous flare"
table1::table1(~ score_group | flare_group,
  data = filtered_data_anxiety,
  render.continuous = my.render.cont
)

#| tbl-cap: "Distribution of baseline anxiety scores by faecal calprotectin"
...
#all tables for tables
#| tbl-cap: "Distribution of baseline depression scores by digaosis type"
table1::table1(~ score_group | diagnosis2,
  data = filtered_data_depression,
  render.continuous = my.render.cont
)

#| tbl-cap: "Distribution of baseline depression scores by sex"
table1::table1(~ score_group | Sex,
  data = filtered_data_depression,
  render.continuous = my.render.cont
)

#| tbl-cap: "Distribution of baseline depression scores by age group"
table1::table1(~ score_group | AgeGroup,
  data = filtered_data_depression,
  render.continuous = my.render.cont
)

#| tbl-cap: "Distribution of baseline depression scores by previous flare"
table1::table1(~ score_group | flare_group,
  data = filtered_data_depression,
  render.continuous = my.render.cont
)
...
```{R}
#| label: tbl-vars-by-depression_cd
#| tbl-cap: "Distribution of baseline depression scores across key variables - CD only"
table1::table1(~ diagnosis2 + Sex + AgeGroup + flare_group + cat | score_group,
  data = depression_cd,
  render.continuous = my.render.cont
)
...
#| tbl-cap: "Distribution of baseline depression scores by sex (CD only)"
table1::table1(~ score_group | Sex,
  data = depression_cd,
  render.continuous = my.render.cont
)

#| tbl-cap: "Distribution of baseline depression scores by age group (CD only)"
table1::table1(~ score_group | AgeGroup,
  data = depression_cd,
  render.continuous = my.render.cont
)

#| tbl-cap: "Distribution of baseline depression scores by previous flare (CD only)"
table1::table1(~ score_group | flare_group,
  data = depression_cd,
  render.continuous = my.render.cont
)

#| tbl-cap: "Distribution of baseline depression scores by faecal calprotectin (CD only)"
table1::table1(~ score_group | cat,
  data = depression_cd,
  render.continuous = my.render.cont
)
...
```{R}
#| label: tbl-vars-by-depression_uc
#| tbl-cap: "Distribution of baseline depression scores across key variables - UC only"
table1::table1(~ diagnosis2 + Sex + AgeGroup + flare_group + cat | score_group,
  data = depression_uc,
  render.continuous = my.render.cont
)

#| tbl-cap: "Distribution of baseline depression scores by sex (UC/IBDU only)"
table1::table1(~ score_group | Sex,
  data = depression_uc,
  render.continuous = my.render.cont
)

#| tbl-cap: "Distribution of baseline depression scores by age group (UC/IBDU only)"
table1::table1(~ score_group | AgeGroup,
  data = depression_uc,
  render.continuous = my.render.cont
)

#| tbl-cap: "Distribution of baseline depression scores by previous flares (UC/IBDU only)"
table1::table1(~ score_group | flare_group,
  data = depression_uc,
  render.continuous = my.render.cont
)

#| tbl-cap: "Distribution of baseline depression scores by faecal calprotectin (UC/IBDU only)"
table1::table1(~ score_group | cat,
  data = depression_uc,
  render.continuous = my.render.cont
)
...
#| tbl-cap: "Anxiety scores and IBD type"
...
# Create the contingency table
#| tbl-cap: "Depression scores and IBD type"
...
# Create the contingency table
#| tbl-cap: "Anxiety scores and sex"
...
#anxiety uc
#| tbl-cap: "Anxiety scores (UC/IBDU) and sex"
...
#anxiety CD
#| tbl-cap: "Anxiety scores (CD) and sex"
...
# Create the contingency table
#| tbl-cap: "Depression scores and sex"
...
#| output: "asis"
#| results: "hold"
#| tbl-cap: "Depression scores (CD) and sex"
...
#| output: "asis"
#| results: "hold"
#| tbl-cap: "Depression scores (UC/IBDU) and sex"
...
#| output: "asis"
#| results: "hold"
#| tbl-cap: "Anxiety scores and age group"
...
#| output: "asis"
#| results: "hold"
#| tbl-cap: "Anxiety scores (CD) and age group"
...
#| output: "asis"
#| results: "hold"
#| tbl-cap: "Anxiety scores (UC/IBDU) and age group"
...
#| output: "asis"
#| results: "hold"
#| tbl-cap: "Depression scores and age group"
...
```{R}
#| tbl-cap: "Depression scores (CD) and age group"
...
```{R}
#| tbl-cap: "Depression scores (UC/IBDU) and age group"
...
#| output: "asis"
#| results: "hold"
#| tbl-cap: "Anxiety scores and previous flares"
...
#| output: "asis"
#| results: "hold"
#| tbl-cap: "Anxiety scores (CD) and previous flares"
...
#| output: "asis"
#| results: "hold"
#| tbl-cap: "Anxiety scores (UC/IBDU) and previous flares"
...
#| output: "asis"
#| results: "hold"
#| tbl-cap: "Depression scores and previous flares"
...
#| output: "asis"
#| results: "hold"
#| tbl-cap: "Depression scores (CD) and previous flares"
...
#| output: "asis"
#| results: "hold"
#| tbl-cap: "Depression scores (UC/IBDU) and previous flares"
...
#| fig-cap: "Distribution of baseline HADS-Anxiety scores and flares reported in the previous year"
...
ggplot(percentages,
       aes(x = score_group,
           ...
           group = flare_group)) +
  geom_line() +
  labs(x = "HADS anxiety score (UC/IBDU)",
       y = "Number of Participants",
       colour = "Flares in the last year",
       group = "Flares in the last year") +
  # Format y-axis as percentage
...
# plots to illustrate the above - depression CD
percentages <- depression_cd %>%
  group_by(flare_group, score_group) %>%
  summarise(count = n()) %>%
  group_by(flare_group) %>%
  mutate(percentage = count / sum(count) * 100)
...
ggplot(percentages, aes(x = score_group,
                        ...
                        group = flare_group)) +
  geom_line() +
  labs(x = "HADS Depression score (CD)",
       y = "Number of Participants",
       colour = "Flares in the last year",
       group = "Flares in the last year") +
  scale_y_continuous(labels = scales::percent_format(scale = 1)) +  # Format y-axis as percentage
...
# plots to illustrate the above - depression UC/IBDU
percentages <- depression_uc %>%
  group_by(flare_group, score_group) %>%
  summarise(count = n()) %>%
  group_by(flare_group) %>%
  mutate(percentage = count / sum(count) * 100)
...
ggplot(percentages, aes(x = score_group,
                        ...
                        group = flare_group)) +
  geom_line() +
  labs(x = "HADS Depression score (UC/IBDU)",
       y = "Number of Participants",
       colour = "Flares in the last year",
       group = "Flares in the last year") +
  scale_y_continuous(labels = scales::percent_format(scale = 1)) +  # Format y-axis as percentage
...
#| tbl-cap: "Anxiety scores and faecal calprotectin"
#anxiety
...
```{R}
#| tbl-cap: "Anxiety scores (CD) and faecal calprotectin"
...
```{R}
#| tbl-cap: "Anxiety scores (UC/IBDU) and faecal calprotectin"
...
```{R}
#| tbl-cap: "Depression scores and faecal calprotectin"
#depression
...
```{R}
#| tbl-cap: "Depression scores (CD) and faecal calprotectin"
...
```{R}
#| tbl-cap: "Depression scores (UC/IBDU) and faecal calprotectin"
...
#| tbl-cap: "Anxiety scores and IBD-Control-8"
#all participants
...
```{R}
#| tbl-cap: "Anxiety scores (CD) and IBD-Control-8"
#anxiety, cd only
...
```{R}
#| tbl-cap: "Anxiety scores (UC/IBDU) and IBD-Control-8"
...
```{R}
#| tbl-cap: "Depression scores and IBD-Control-8"
#depression, all
...
```{R}
#| tbl-cap: "Depression scores (UC/IBDU) and IBD-Control-8"
#depression, uc/ibdu
...
```{R}
#| tbl-cap: "Depression scores (CD) and IBD-Control-8"
#depression, CD only
...
#| tbl-cap: "Anxiety scores and IBD-Control-VAS"
#all participants
data_flare_a <- hads_control[hads_control$hads_type == "anxiety_hads",]
...
```{R}
#| tbl-cap: "Anxiety scores (UC/IBDU) and IBD-Control-VAS"
#anxiety, uc/ibdu only
data_flare_b <- data_flare_a[data_flare_a$diagnosis2 == "UC/IBDU",]
...
```{R}
#| tbl-cap: "Anxiety scores (CD) and IBD-Control-VAS"
#anxiety, cd only
data_flare_c <- data_flare_a[data_flare_a$diagnosis2 == "CD",]
...
```{R}
#| tbl-cap: "Depression scores and IBD-Control-VAS"
#depression, all
data_flare_d <- hads_control[hads_control$hads_type == "depression_hads",]
...
```{R}
#| tbl-cap: "Depression scores (UC/IBDU) and IBD-Control-VAS"
#depression, uc/ibdu
data_flare_e <- data_flare_d[data_flare_d$diagnosis2 == "UC/IBDU",]
...
```{R}
#| tbl-cap: "Depression scores (CD) and IBD-Control-VAS"
#depression, CD only
data_flare_f <- data_flare_d[data_flare_d$diagnosis2 == "CD",]

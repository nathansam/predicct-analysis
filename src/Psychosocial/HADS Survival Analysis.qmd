...
Here we present survival analysis (time to soft and hard flare) using cox-regression models, stratifying by HADS anxiety/depression groups. 

We conducted three survival analyses:
1. Controlling for site only
2. Controlling for sex, smoking, IMD, site +/- age (if this was found to be signifjcantly associated with scores at baseline). 
3. Controlling for factors above and faecal calprotectin additionally. 

Each analysis was conducted for the whole IBD cohort, and for UC/IBDU and CD separately.
...
* controlling for site only, significant association both moderate (p=value = 9.5e-05) and severe (p-value = 1.1e-07) anxiety
...
* remains significant when controlling for FC additionally for moderate (p-value = 0.001, 95% CI 1.14-1.73) and severe (p-value < 0.00001, 95% CI 1.31-2.02)
...
* controlling for site only, significant for moderate (p-value = 0.0009, 95% CI 1.18-1.95) and severe (p-value 0.014, 95% CI 1.08-2.07)
...
* controlling for FC additionally - significant for moderate (0.0008, 95% CI 1.19-1.99) and severe (p-value = 0.043, 95% CI 1.01-1.95) depression
...
* Controlling for site only, significant association with moderate depression (p-value 0.005, 95% CI 1.18-2.60) but no significant association with severe depression
* Significant for moderate depression (p-value = 0.012, 95% CI 1.12-2.48) in analysis 2
* Controlling for FC additionally, significiant for moderate depression (p-value = 0.009, 95% CI 1.14-2.54)
...
*	Controlling for site only, significant association with severe anxiety and risk of flare (p-value = 0.0024, 95% CI 1.17 - 2.14)
*	Controlling for site, sex, smoking, IMD and age group significant association with severe anxiety and risk of flare (p-value = 0.021, 95% CI 1.05 - 1.95)
*	Controlling for site, sex, smoking, IMD, age group and FC significant association with severe anxiety and risk of flare (p-value = 0.011, 95% CI 1.09- 2.02)


#### UC/IBDU depression scores and soft flares

*	Controlling for site only, significant association with moderate depression and risk of flare (p-value = 0.008, 95% CI 1.12 - 2.25) and severe depression (p-value = 0.037, 95% CI 1.032-2.652)
*	Controlling for site, sex, smoking, IMD and age group, significant association with moderate (p-value = 0.009, 95% CI 1.13- 2.25) and severe (p-value = 0.040, 95% CI 1.02 - 2.66) depression and risk of flare
*	Controlling for site, sex, smoking and FC significant association with moderate (p-value = 0.004, 95% CI 1.27- 2.56) and severe (p-value = 0.048, 95% CI 1.01 - 2.62) depression and risk of flare 
...
#3 +FC
cox_model <- coxph(Surv(time, DiseaseFlareYN) ~ score_group + Sex + Smoke + AgeGroup + IMD + cat + frailty(SiteNo), data = soft_uc_anx)
...
n= 780, number of events= 119 


#### UC/IBDU Anxiety and time to hard flare

* Controlling for site only no significant association
* Controlling for site, sex, smoking, IMD and age, no significant association
* Controlling for site, sex, smoking, IMD, age and FC, no significant association
...
* Controlling for site only, significant association with moderate (8-10) depression and increased risk of hard flare (p-value 0.004, 95% CI 1.29-3.56)
* Controlling for site, sex, smoking, IMD and age, significant association with moderate (8-10) (p-value = 0.002, 95% CI 1.32-3.80) and severe (p-value = 0.034, 95% CI 1.06-4.79) depression
* Controlling for confounders above and FC, significant association with moderate (8-10) (p-value = 0.0003, 95% CI 1.57-4.67) and severe (p-value = 0.041, 95% CI 1.03-4.69) depression
...
* Controlling for site only, significant associations with moderate (p-value = 0.0013, 95% CI 1.32-2.36) and severe anxiety (p-value > 0.00001, 95% CI 1.48-2.64) (remains strongly associate using FC dataset)
* Controlling for site, sex, smoking, IMD and age group, significant associations with moderate (p-value = 0.013, 95% CI 1.21-2.22) and severe anxiety (p-value > 0.0001, 95% CI 1.37-2.50)
*	Controlling for site, sex, smoking, IMD and age group, FC significant associations with moderate (p-value = 0.002, 95% CI 1.21-2.21) and severe anxiety (p-value > 0.0001, 95% CI 1.36-2.49) 

#### CD depression scores

*	Controlling for site only – significant for moderate depression (p-value = 0.038, 95% CI 1.02-2.09)
*	Controlling for site, sex, smoking and IMD – no significant associations
*	Controlling for site, sex, smoking, IMD and FC – no significant associations
...
#site/sex/smoke/fc
cox_model <- coxph(Surv(time, DiseaseFlareYN) ~ score_group + Sex + Smoke + AgeGroup + IMD + cat + frailty(SiteNo), data = soft_cd_anx)
...
#site/sex/smoke/IMD/age
cox_model <- coxph(Surv(time, DiseaseFlareYN) ~ score_group + Sex + IMD + Smoke + frailty(SiteNo), data = soft_cd_dep)

fit.me <- coxph(Surv(time, DiseaseFlareYN) ~
                  Sex + Smoke + IMD + score_group + frailty(SiteNo),
                data = soft_cd_dep)
summary(cox_model)

#add FC
cox_model <- coxph(Surv(time, DiseaseFlareYN) ~ score_group + Sex + IMD + Smoke + cat + frailty(SiteNo), data = soft_cd_dep)

fit.me <- coxph(Surv(time, DiseaseFlareYN) ~
                  Sex + Smoke + IMD + score_group + cat + frailty(SiteNo),
                data = soft_cd_dep)
summary(cox_model)
...
#analysis 2
cox_model <- coxph(Surv(time, DiseaseFlareYN) ~ score_group + Sex + Smoke + IMD + frailty(SiteNo), data = flare_cd_dep)
summary(cox_model)

#analysis 3 (FC)
cox_model <- coxph(Surv(time, DiseaseFlareYN) ~ score_group + Sex + Smoke + IMD + cat + frailty(SiteNo), data = flare_cd_dep)
summary(cox_model)
```
...
* Whole cohort and soft flare
  ...
  * Significant controlling for site, sex, smoking, age, IMD  and age group (p-value = 0.0003, 95% CI 1.19-1.81)
  * Significant controlling fo FC additionally (p-value = 0.0002, 95% CI 1.20-1.84)
* CD only and soft flare
  * Significantly only when controlling for site only (p-value 0.016, 95% CI 1.20-1.93)
* UC only and soft flare
  * Significant controlling for site only (p-value = 0.0013, 95% CI 1.20-2.15)
  * Significant controlling for site, sex, smoking, age, IMD (p-value = 0.0015, 95% CI 1.20-2.16)
  * Significant controlling fo FC additionally (p-value = 0.0008, 95% CI 1.23-2.23)
...
#analysis 2
cox_model <- coxph(Surv(time, DiseaseFlareYN) ~ score_group + Sex + Smoke + IMD + frailty(SiteNo), data = soft_dep_grouped_CD)
summary(cox_model)

#analysis 3 (FC)
cox_model <- coxph(Surv(time, DiseaseFlareYN) ~ score_group + Sex + Smoke + IMD + cat + frailty(SiteNo), data = soft_dep_grouped_CD)
summary(cox_model)
```
...
* Whole cohort (n= 1574, number of events= 217)
  * statistically significant controlling for site only (p-value = 0.0059, 95% CI 1.14 - 2.24)
  * statistically significant controlling for site, sex, smoking, IMD, age group (p-value = 0.008, 95% CI 1.12-2.22)
...
* UC only (n= 771, number of events= 119)
  ...
  * statistically significant controlling for site, sex, smoking, IMD, age group (p-value = 0.0005, 95% CI 1.42-3.55)
  * statistically significant controlling for FC category additionally (p-value = 0.00009, 95% CI (1.58-4.02))
...
#analysis 2
cox_model <- coxph(Surv(time, DiseaseFlareYN) ~ score_group + Sex + Smoke + IMD + frailty(SiteNo), data = hard_dep_grouped_CD)
summary(cox_model)

#analysis 3 (FC)
cox_model <- coxph(Surv(time, DiseaseFlareYN) ~ score_group + Sex + Smoke + IMD + cat + frailty(SiteNo), data = hard_dep_grouped_CD)
summary(cox_model)
```

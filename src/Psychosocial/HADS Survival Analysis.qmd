...
2. Controlling for sex, smoking, IMD, site +/- age (if this was found to be signficantly associated with scores at baseline). 
3. Controlling for factors above and faecal calprotectin additionally. 

Each analysis was conducted for the whoel IBD cohort, and for UC/IBDU and CD separately.

### Key findings


Maybe take this bit out?
* Moderate depression scores (8-10) are associated with an increase risk in hard flare in UC/IBDU cohort (p-value = 0.0024; controlling for FC p-value = 0.0004)
...
Below are other bits to put in somwehere - here?
...
-----------------------------------------
End of whole group analysis
------------------------------------------


# Analyses by subgroups (CD vs UC/IBDU)

n= 800, number of events= 314 
...
#### Anxiety and time to hard flare
...
#### Depression and time to hard flare

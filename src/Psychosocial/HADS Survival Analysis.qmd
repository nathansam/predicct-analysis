...
p1 <- ggsurvplot(fit,
  ...
  title = "Whole cohort - Time to patient-reported flare"
)
p1
```
...
p.uc.anx <- ggsurvplot(fit,
  ...
  palette = c("#42213D", "#BD4089", "#F51AA4"),
  xlab = "Time from study recruitment (days)",
  title = "UC/IBDU - Time to patient-reported flare"
)
...
p.cd.anx <- ggsurvplot(fit,
  ...
  palette = c("#42213D", "#BD4089", "#F51AA4"),
  xlab = "Time from study recruitment (days)",
  title = "CD - Time to patient-reported flare"
)
p.cd.anx
```
...
p5 <- ggsurvplot(fit,
  ...
  xlab = "Time from study recruitment (days)",
  title = "All patients - Time to patient-reported flare"
)
p5
```

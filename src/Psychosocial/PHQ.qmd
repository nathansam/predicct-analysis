...
ggplot(phq_percent, aes(x = somatisation, y = Percentage, fill = diagnosis2)) +
  ...
  labs(title = "Distribution of somatisation by diagnosis type",
...
alpha <- 0.05
if (chi_squared_result$p.value < alpha) {
  message("There is a significant association between somatisation scores and flares in last year")
} else {
  message("There is no significant association between somatisation scores and flares in last year")
}
...
table1::table1(~ somatisation| Sex,
  data = CD_phq,
  render.continuous = my.render.cont,
  title = "Sleep Disturbance Across Categories "
)
...
table1::table1(~ somatisation| flare_group,
  data = CD_phq,
  render.continuous = my.render.cont,
  title = "Sleep Disturbance Across Categories "
)

table1::table1(~ somatisation| cat,
  data = CD_phq,
  render.continuous = my.render.cont,
  title = "Sleep Disturbance Across Categories "
)

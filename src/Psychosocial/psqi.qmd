...
psqi2 <- psqi2 %>% 
  left_join(demographics %>%
              select(ParticipantNo, Sex, age, diagnosis), by  = "ParticipantNo")
#code diagnosis
...
psqi2$flare_group <- factor(psqi2$flare_group,
...
```{R}
# exclude participants 110415 and 110463 - cases in which bed time was accurately

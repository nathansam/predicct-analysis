...
table1::table1(~ SleepDisturbance | diagnosis2,
  data = psqi2,
  render.continuous = my.render.cont
)

table1::table1(~ SleepDisturbance | Sex,
  data = psqi2,
  render.continuous = my.render.cont
)

table1::table1(~ SleepDisturbance | AgeGroup,
  data = psqi2,
  render.continuous = my.render.cont
)

table1::table1(~ SleepDisturbance | flare_group,
  data = psqi2,
  render.continuous = my.render.cont
)

table1::table1(~ SleepDisturbance | cat,
  data = psqi2,
  render.continuous = my.render.cont
)
```

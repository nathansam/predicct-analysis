...
#| tbl-cap: "ANOVA between protein intake from meat and FC groups in the CD cohort."
...
#| tbl-cap: "ANOVA between protein intake from meat and FC groups in the UC/IBDU cohort."
...
```{R}
#| label: tbl-fibre-cd
#| tbl-cap: "ANOVA between dietary fibre and FC groups in the CD cohort."
demo %>%
  filter(diagnosis2 == "CD") %>%
...
```{R}
#| label: tbl-fibre-uc
#| tbl-cap: "ANOVA between dietary fibre and FC groups in the UC/IBDU cohort."
demo %>%
  filter(diagnosis2 == "UC/IBDU") %>%
  aov(formula = fibre ~ cat, data = .) %>%
  summary() %>%
...
```{R}
#| label: tbl-pufa-cd
#| tbl-cap: "ANOVA between polyunsaturated fatty acids and FC groups in the CD cohort."
demo %>%
  filter(diagnosis2 == "CD") %>%
...
```{R}
#| label: tbl-pufa-uc
#| tbl-cap: "ANOVA between polyunsaturated fatty acids and FC groups in the UC/IBDU cohort."
demo %>%
  filter(diagnosis2 == "UC/IBDU") %>%
  aov(formula = PUFA_percEng ~ cat, data = .) %>%
  summary() %>%
...
#| tbl-cap: "Chi-squared test between Nova intake score and FC groups in the CD cohort."
demo %>%
  filter(diagnosis2 == "CD") %>%
...
#| tbl-cap: "Chi-squared test between Nova intake score and FC groups in the UC/IBDU cohort."
demo %>%
  filter(diagnosis2 == "UC/IBDU") %>%
  select(NOVAScore_cat, cat) %>%
  table() %>%
...
#| tbl-cap: "ANOVA between sweet/dessert/snack intake and FC groups in the CD cohort."
demo %>%
  filter(diagnosis2 == "CD") %>%
...
#| tbl-cap: "ANOVA between sweet/dessert/snack intake and FC groups in the UC/IBDU cohort."
demo %>%
  filter(diagnosis2 == "UC/IBDU") %>%
  aov(formula = sweetIntake ~ cat, data = .) %>%
  summary() %>%
...
#| tbl-cap: "ANOVA between artificial/sugar-sweetened beverage intake and FC groups in the CD cohort."
demo %>%
  filter(diagnosis2 == "CD") %>%
...
#| tbl-cap: "ANOVA between artificial/sugar-sweetened beverage intake and FC groups in the UC/IBDU cohort."
demo %>%
  filter(diagnosis2 == "UC/IBDU") %>%
  aov(formula = drinkIntake ~ cat, data = .) %>%
  summary() %>%
...
#| tbl-cap: "ANOVA between processed meat intake and FC groups in the CD cohort."
demo %>%
  filter(diagnosis2 == "CD") %>%
...
#| tbl-cap: "ANOVA between processed meat intake and FC groups in the UC/IBDU cohort."
...
As intake of processed meat appeared to be associated with FC at recruitment, we
explored the distribution processed meat intake within FC categories. From
@fig-processedMeatIntake-FC, it appears subjects with FC<50μg/g at recruitment
were more likely to consume no, or low levels of, processed meat. 
...
#| tbl-cap: "ANOVA between processed plant-based alternatives intake and FC groups in the CD cohort."
demo %>%
  filter(diagnosis2 == "CD") %>%
...
#| tbl-cap: "ANOVA between processed plant-based alternatives intake and FC groups in the UC cohort."
demo %>%
  filter(diagnosis2 == "UC/IBDU") %>%
  aov(formula = processedPlantIntake ~ cat, data = .) %>%
  summary() %>%
...
```{R}
demo.cd %>%
  drop_na(ileal, processedMeatIntake) %>%
...
```{R}
demo.cd %>%
  drop_na(ileal, processedPlantIntake) %>%
...
#| tbl-cap: "ANOVA between fruit intake and FC groups in the CD cohort."
demo %>%
  filter(diagnosis2 == "CD") %>%
...
#| tbl-cap: "ANOVA between fruit intake and FC groups in the UC/IBDU cohort."
demo %>%
  filter(diagnosis2 == "UC/IBDU") %>%
  aov(formula = fruitIntake ~ cat, data = .) %>%
  summary() %>%
...
#| tbl-cap: "ANOVA between vegetable/legume intake and FC groups in the CD cohort."
demo %>%
  filter(diagnosis2 == "CD") %>%
...
#| tbl-cap: "ANOVA between vegetable/legume intake and FC groups in the UC/IBDU cohort."
demo %>%
  filter(diagnosis2 == "UC/IBDU") %>%
  aov(formula = vegIntake ~ cat, data = .) %>%
  summary() %>%
...
#| tbl-cap: "ANOVA between red meat intake and FC groups in the CD cohort."
demo %>%
  filter(diagnosis2 == "CD") %>%
...
#| tbl-cap: "ANOVA between red meat intake and FC groups in the UC/IBDU cohort."
demo %>%
  filter(diagnosis2 == "UC/IBDU") %>%
  aov(formula = redMeatIntake ~ cat, data = .) %>%
  summary() %>%
...
#| tbl-cap: "ANOVA between white meat intake and FC groups in the CD cohort."
demo %>%
  filter(diagnosis2 == "CD") %>%
...
#| tbl-cap: "ANOVA between white meat intake and FC groups in the UC/IBDU cohort."
demo %>%
  filter(diagnosis2 == "UC/IBDU") %>%
  aov(formula = whiteMeatIntake ~ cat, data = .) %>%
  summary() %>%
...
#| tbl-cap: "ANOVA between fish (white and oily) intake and FC groups in the CD cohort."
demo %>%
  filter(diagnosis2 == "CD") %>%
...
#| tbl-cap: "ANOVA between fish (white and oily) intake and FC groups in the UC/IBDU cohort."
demo %>%
  filter(diagnosis2 == "UC/IBDU") %>%
  aov(formula = whiteFishIntake ~ cat, data = .) %>%
  summary() %>%
...
```{R}
#| label: tbl-alcohol-cd
#| tbl-cap: "ANOVA between alcohol intake and FC groups in the CD cohort."
...
```{R}
#| label: tbl-alcohol-uc
#| tbl-cap: "ANOVA between alcohol intake and FC groups in the UC/IBDU cohort."
...
```{R}
#| label: tbl-dqi-cd
#| tbl-cap: "ANOVA between diet quality index and FC groups in the CD cohort."
demo %>%
  filter(diagnosis2 == "CD") %>%
...
```{R}
#| label: tbl-dqi-uc
#| tbl-cap: "ANOVA between diet quality index and FC groups in the UC/IBDU cohort."
demo %>%
  filter(diagnosis2 == "UC/IBDU") %>%
  aov(formula = dqi_tot ~ cat, data = .) %>%
  summary() %>%
...
#| warning: false
#| fig-width: 8
FFQ$Prot_percEng <- FFQ$Protng * 4 / FFQ$EnergykCAL

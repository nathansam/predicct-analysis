...
cd.clin.forest <- readRDS(paste0(outdir, "cd-clin-IBD.RDS"))
cd.hard.forest <- readRDS(paste0(outdir, "cd-hard-IBD.RDS"))
uc.clin.forest <- readRDS(paste0(outdir, "uc-clin-IBD.RDS"))
uc.hard.forest <- readRDS(paste0(outdir, "uc-hard-IBD.RDS"))
...
saveRDS(cd.clin.forest, paste0(outdir, "cd-clin-biochem.RDS"))
saveRDS(cd.hard.forest, paste0(outdir, "cd-hard-biochem.RDS"))
saveRDS(uc.clin.forest, paste0(outdir, "uc-clin-biochem.RDS"))
saveRDS(uc.hard.forest, paste0(outdir, "uc-hard-biochem.RDS"))
```

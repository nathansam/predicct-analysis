...
[control for smoking status](Survival/Smoking/Diet.qmd) by imputing missing
smoking data and
[control for FC as a continuous variable](Survival/FC\ continuous/Diet.qmd) via
splines. 

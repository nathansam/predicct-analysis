...
# Run Cox model for continuous variable
fit.me <- coxph(
...
# Run survival analysis using utility function for hard flare
analysis_result <- run_survival_analysis(
  data = flare.cd.df,
  var_name = "Meat_sum",
...
fit.me <- coxph(
  Surv(hardflare_time, hardflare) ~
    Sex + cat + IMD + dqi_tot + BMI + fish_overall + frailty(SiteNo),
  control = coxph.control(outer.max = 20),
  data = flare.cd.df
)
...
fit.me <- coxph(
  Surv(softflare_time, softflare) ~
    Sex + cat + IMD + dqi_tot + BMI + fibre + frailty(SiteNo),
  control = coxph.control(outer.max = 20),
  data = flare.cd.df
)
...
fit.me <- coxph(
  Surv(hardflare_time, hardflare) ~
    Sex + cat + IMD + dqi_tot + BMI + PUFA_percEng + frailty(SiteNo),
  control = coxph.control(outer.max = 20),
  data = flare.cd.df
)
...
fit.me <- coxph(
  Surv(softflare_time, softflare) ~
    Sex + cat + IMD + dqi_tot + BMI + PUFA_percEng +
    frailty(SiteNo),
  control = coxph.control(outer.max = 20),
  data = flare.uc.df
)
...
fit.me <- coxph(
  Surv(softflare_time, softflare) ~
    Sex + cat + IMD + dqi_tot + BMI + UPF_perc + frailty(SiteNo),
  control = coxph.control(outer.max = 20),
  data = flare.cd.df
)
...
fit.me <- coxph(
  Surv(softflare_time, softflare) ~
    Sex + cat + IMD + dqi_tot + BMI + UPF_perc +
    frailty(SiteNo),
  control = coxph.control(outer.max = 20),
  data = flare.uc.df
)
...
fit.me <- coxph(
  Surv(softflare_time, softflare) ~
    Sex + cat + IMD + dqi_tot + BMI + breadIntake + frailty(SiteNo),
  control = coxph.control(outer.max = 20),
  data = flare.cd.df
)
...
fit.me <- coxph(
  Surv(softflare_time, softflare) ~
    Sex + cat + IMD + dqi_tot + BMI + breadIntake +
    frailty(SiteNo),
  control = coxph.control(outer.max = 20),
  data = flare.uc.df
)
...
fit.me <- coxph(
  Surv(softflare_time, softflare) ~
    Sex + cat + IMD + dqi_tot + BMI + sweetIntake + frailty(SiteNo),
  control = coxph.control(outer.max = 20),
  data = flare.cd.df
)
...
fit.me <- coxph(
  Surv(softflare_time, softflare) ~
    Sex + cat + IMD + dqi_tot + BMI + sweetIntake +
    frailty(SiteNo),
  control = coxph.control(outer.max = 20),
  data = flare.uc.df
)
...
fit.me <- coxph(
  Surv(softflare_time, softflare) ~
    Sex + cat + IMD + dqi_tot + BMI + drinkIntake + frailty(SiteNo),
  control = coxph.control(outer.max = 20),
  data = flare.cd.df
)
...
fit.me <- coxph(
  Surv(softflare_time, softflare) ~
    Sex + cat + IMD + dqi_tot + BMI + drinkIntake +
    frailty(SiteNo),
  control = coxph.control(outer.max = 20),
  data = flare.uc.df
)
...
fit.me <- coxph(
  Surv(softflare_time, softflare) ~
    Sex + cat + IMD + dqi_tot + BMI + processedMeatIntake + frailty(SiteNo),
  control = coxph.control(outer.max = 20),
  data = flare.cd.df
)
...
fit.me <- coxph(
  Surv(softflare_time, softflare) ~
    Sex + cat + IMD + dqi_tot + BMI + processedMeatIntake +
    frailty(SiteNo),
  control = coxph.control(outer.max = 20),
  data = flare.uc.df
)
...
# Categorize processed plant intake by quantiles (with unique breaks for zeros)
...
fit.me <- coxph(
  Surv(softflare_time, softflare) ~
    Sex + cat + IMD + dqi_tot + BMI + processedPlantIntake + frailty(SiteNo),
  control = coxph.control(outer.max = 20),
  data = flare.cd.df
)
...
fit.me <- coxph(
  Surv(softflare_time, softflare) ~
    Sex + cat + IMD + dqi_tot + BMI + processedPlantIntake +
    frailty(SiteNo),
  control = coxph.control(outer.max = 20),
  data = flare.uc.df
)
...
fit.me <- coxph(
  Surv(softflare_time, softflare) ~
    Sex + cat + IMD + dqi_tot + BMI + fruitIntake + frailty(SiteNo),
  control = coxph.control(outer.max = 20),
  data = flare.cd.df
)
...
fit.me <- coxph(
  Surv(softflare_time, softflare) ~
    Sex + cat + IMD + dqi_tot + BMI + fruitIntake +
    frailty(SiteNo),
  control = coxph.control(outer.max = 20),
  data = flare.uc.df
)
...
fit.me <- coxph(
  Surv(hardflare_time, hardflare) ~
    Sex + cat + IMD + fruitIntake + dqi_tot + BMI + frailty(SiteNo),
  control = coxph.control(outer.max = 20),
  data = flare.uc.df
)
...
fit.me <- coxph(
  Surv(softflare_time, softflare) ~
    Sex + cat + IMD + dqi_tot + BMI + vegIntake + frailty(SiteNo),
  control = coxph.control(outer.max = 20),
  data = flare.cd.df
)
...
fit.me <- coxph(
  Surv(softflare_time, softflare) ~
    Sex + cat + IMD + dqi_tot + BMI + vegIntake +
    frailty(SiteNo),
  control = coxph.control(outer.max = 20),
  data = flare.uc.df
)
...
# Categorize red meat intake by quantiles (with unique breaks)
...
fit.me <- coxph(
  Surv(softflare_time, softflare) ~
    Sex + cat + IMD + dqi_tot + BMI + redMeatIntake + frailty(SiteNo),
  control = coxph.control(outer.max = 20),
  data = flare.cd.df
)
...
fit.me <- coxph(
  Surv(softflare_time, softflare) ~
    Sex + cat + IMD + dqi_tot + BMI + redMeatIntake +
    frailty(SiteNo),
  control = coxph.control(outer.max = 20),
  data = flare.uc.df
)
...
# Categorize white meat intake by quantiles (with unique breaks)
...
fit.me <- coxph(
  Surv(softflare_time, softflare) ~
    Sex + cat + IMD + whiteMeatIntake + dqi_tot + BMI + frailty(SiteNo),
  control = coxph.control(outer.max = 20),
  data = flare.cd.df
)
...
fit.me <- coxph(
  Surv(hardflare_time, hardflare) ~
    Sex + cat + IMD + dqi_tot + BMI + whiteMeatIntake + frailty(SiteNo),
  control = coxph.control(outer.max = 20),
  data = flare.cd.df
)
...
fit.me <- coxph(
  Surv(softflare_time, softflare) ~
    Sex + cat + IMD + dqi_tot + BMI + whiteMeatIntake +
    frailty(SiteNo),
  control = coxph.control(outer.max = 20),
  data = flare.uc.df
)
...
# Categorize white fish intake by quantiles (with unique breaks)
...
fit.me <- coxph(
  Surv(softflare_time, softflare) ~
    Sex + cat + IMD + dqi_tot + BMI + whiteFishIntake + frailty(SiteNo),
  control = coxph.control(outer.max = 20),
  data = flare.cd.df
)
...
fit.me <- coxph(
  Surv(softflare_time, softflare) ~
    Sex + cat + IMD + dqi_tot + BMI + whiteFishIntake +
    frailty(SiteNo),
  control = coxph.control(outer.max = 20),
  data = flare.uc.df
)

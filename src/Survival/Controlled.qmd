...
cairo_pdf("plots/EOF-flare-IMD-cd-cut.pdf", width = 9, height = 7)
p
invisible(dev.off())

png("plots/EOF-flare-IMD-cd-cut.png",
  width = 9,
  height = 7,
  units = "in",
  res = 300
...
cairo_pdf("plots/EOF-flare-IMD-cd-full.pdf", width = 9, height = 7)
p
invisible(dev.off())

png("plots/EOF-flare-IMD-cd-full.png",
  width = 9,
  height = 7,
  units = "in",
  res = 300
...
cairo_pdf("plots/EOF-flare-IMD-uc-cut.pdf", width = 9, height = 7)
p
invisible(dev.off())

png("plots/EOF-flare-IMD-uc-cut.png",
  width = 9,
  height = 7,
  units = "in",
  res = 300
...
cairo_pdf("plots/EOF-flare-IMD-uc-full.pdf", width = 9, height = 7)
p
invisible(dev.off())

png("plots/EOF-flare-IMD-uc-full.png",
  width = 9,
  height = 7,
  units = "in",
  res = 300
...
cairo_pdf("plots/EOF-flare-FC-cd-cut.pdf", width = 7, height = 6.5)
p
invisible(dev.off())

png("plots/EOF-flare-FC-cd-cut.png",
  width = 9,
  height = 7,
  units = "in",
  res = 300
...
cairo_pdf("plots/EOF-flare-FC-cd-full.pdf", width = 7, height = 6.5)
p
invisible(dev.off())

png("plots/EOF-flare-FC-cd-full.png",
  width = 7,
  height = 6.5,
  units = "in",
  res = 300
...
cairo_pdf("plots/EOF-flare-FC-uc-cut.pdf", width = 7, height = 6.5)
p
invisible(dev.off())

png("plots/EOF-flare-FC-uc-cut.png",
  width = 9,
  height = 7,
  units = "in",
  res = 300
...
cairo_pdf("plots/EOF-flare-FC-uc-full.pdf", width = 7, height = 6.5)
p
invisible(dev.off())

png("plots/EOF-flare-FC-uc-full.png",
  width = 7,
  height = 6.5,
  units = "in",
  res = 300

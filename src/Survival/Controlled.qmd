...
```{R}
#| fig-height: 6
#| label: fig-sex-cd-soft
#| fig-cap: "Time to patient-reported flare in Crohn's disease by sex."
...
```{R}
#| fig-height: 6
#| label: fig-sex-cd-hard
#| fig-cap: "Time to objective flare in Crohn's disease by sex."
p <- generate_survival_plot(
  data = flare.cd.df,
...
```{R}
#| fig-height: 6
#| label: fig-sex-uc-soft
#| fig-cap: "Time to patient-reported flare in ulcerative colitis by sex."
p <- generate_survival_plot(
  data = flare.uc.df,
  formula = Surv(softflare_time, softflare) ~ Sex,
  legend_title = "Sex",
...
```{R}
#| fig-height: 6
#| label: fig-sex-uc-hard
#| fig-cap: "Time to objective flare in ulcerative colitis by sex."
p <- generate_survival_plot(
  data = flare.uc.df,
  formula = Surv(hardflare_time, hardflare) ~ Sex,
  legend_title = "Sex",

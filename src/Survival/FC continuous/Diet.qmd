...
# Creating combined forest plot
# 1-year risk difference
plot_rd_cd_hard_meat_1y <- summon_rd_forest_plot(data_rd_cd_hard_meat, time = 365)

plot_rd_cd_hard_fibre_1y <- summon_rd_forest_plot(data_rd_cd_hard_fibre, time = 365)

plot_rd_cd_hard_pufa_1y <- summon_rd_forest_plot(data_rd_cd_hard_pufa, time = 365)

plot_rd_cd_hard_upf_1y <- summon_rd_forest_plot(data_rd_cd_hard_upf, time = 365)

# 2-year risk difference
plot_rd_cd_hard_meat_2y <- summon_rd_forest_plot(data_rd_cd_hard_meat, time = 730)

plot_rd_cd_hard_fibre_2y <- summon_rd_forest_plot(data_rd_cd_hard_fibre, time = 730)

plot_rd_cd_hard_pufa_2y <- summon_rd_forest_plot(data_rd_cd_hard_pufa, time = 730)

plot_rd_cd_hard_upf_2y <- summon_rd_forest_plot(data_rd_cd_hard_upf, time = 730)
```

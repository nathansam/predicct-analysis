...
plot_continuous_hr <- function(data, model, variable, xlab = NULL) {
  if (is.null(xlab)) {
    xlab <- variable
  }
  ...
  data %>%
    ...
    {
      # Predict uses the mean as the reference level by default
...
Risk differences quantify the absolute change in cumulative incidence of flare at specific time points (1 and 2 years) associated with different levels of each dietary exposure. These are population-averaged estimates obtained by:
...
plot_rd_cd_soft_meat_2y <- summon_rd_forest_plot(data_rd_cd_soft_meat,
  time = 730
)

plot_rd_cd_soft_fibre_2y <- summon_rd_forest_plot(data_rd_cd_soft_fibre,
  time = 730
)

plot_rd_cd_soft_pufa_2y <- summon_rd_forest_plot(data_rd_cd_soft_pufa,
  time = 730
)

plot_rd_cd_soft_upf_2y <- summon_rd_forest_plot(data_rd_cd_soft_upf,
  time = 730
)
```
...
# 2-year risk difference
plot_rd_cd_hard_meat_2y <- summon_rd_forest_plot(data_rd_cd_hard_meat,
  time = 730
)

plot_rd_cd_hard_fibre_2y <- summon_rd_forest_plot(data_rd_cd_hard_fibre,
  time = 730
)

plot_rd_cd_hard_pufa_2y <- summon_rd_forest_plot(data_rd_cd_hard_pufa,
  time = 730
)

plot_rd_cd_hard_upf_2y <- summon_rd_forest_plot(data_rd_cd_hard_upf,
  time = 730
)
```
...
#| warning: false
# 2-year risk difference
plot_rd_cd_hard_meat_2y$plot + (plot_rd_cd_hard_meat_2y$rd +
  labs(title = "Risk difference (95% CI)")) +
  plot_rd_cd_hard_fibre_2y$plot + plot_rd_cd_hard_fibre_2y$rd +
  plot_rd_cd_hard_pufa_2y$plot + plot_rd_cd_hard_pufa_2y$rd +
  plot_rd_cd_hard_upf_2y$plot + plot_rd_cd_hard_upf_2y$rd +
  patchwork::plot_layout(
    ncol = 2,
    guides = "collect",
    axes = "collect",
...
# 2-year risk difference
plot_rd_uc_soft_meat_2y <- summon_rd_forest_plot(data_rd_uc_soft_meat,
  time = 730
)

plot_rd_uc_soft_fibre_2y <- summon_rd_forest_plot(data_rd_uc_soft_fibre,
  time = 730
)

plot_rd_uc_soft_pufa_2y <- summon_rd_forest_plot(data_rd_uc_soft_pufa,
  time = 730
)
...
# 2-year risk difference
plot_rd_uc_hard_meat_2y <- summon_rd_forest_plot(data_rd_uc_hard_meat,
  time = 730
)

plot_rd_uc_hard_fibre_2y <- summon_rd_forest_plot(data_rd_uc_hard_fibre,
  time = 730
)

plot_rd_uc_hard_pufa_2y <- summon_rd_forest_plot(data_rd_uc_hard_pufa,
  time = 730
)

plot_rd_uc_hard_upf_2y <- summon_rd_forest_plot(data_rd_uc_hard_upf,
  time = 730
)
```

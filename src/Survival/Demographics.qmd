...
cd.clin.forest <- GetHR(fit.me, c("Age", "SexFemale"))
...
cd.hard.forest <- GetHR(fit.me, c("Age", "SexFemale"))
...
uc.clin.forest <- GetHR(fit.me, c("Age", "SexFemale"))
...
uc.hard.forest <- GetHR(fit.me, c("Age", "SexFemale"))
